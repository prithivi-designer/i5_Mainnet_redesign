...
const MOCK_KOL_LEADERBOARD_ENTRIES: FullKolLeaderboardEntry[] = [
  ...
  },
  {
    id: "machi",
    rank: 9,
    kolName: "Machi Big Brother",
    kolHandle: "@machibigbrother",
    kolAddress: "0x02...B831",
    kolAvatar: "👑",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    followers: "$290.0K followers",
    winRate: 73.5,
    wins: 48,
    losses: 17,
    pnl: "+$30.40M",
    ...
    kdaRatio: "2.82",
    totalVolume: "$260.10M",
    bestCall: "$DOGE2 (+$175.0K)",
    topHolding: { name: "PEPECLON", ticker: "$PCLON", avatar: "🐸", kolBag: "$34.0K" },
  },
  {
    id: "crash",
    rank: 10,
    kolName: "Crash Trading",
    kolHandle: "@CrashTrading",
    kolAddress: "0x81...44D1",
    kolAvatar: "⚡",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$310.0K followers",
    winRate: 72.8,
    wins: 52,
    losses: 19,
    pnl: "+$28.50M",
    ...
    kdaRatio: "2.74",
    totalVolume: "$245.80M",
    bestCall: "$QCAT (+$160.0K)",
    topHolding: { name: "MOONCAT", ticker: "$MCAT", avatar: "🐱", kolBag: "$31.5K" },
  },
  {
    id: "gcr",
    rank: 11,
    kolName: "GCR (Classic Calls)",
    kolHandle: "@GiganticRebirth",
    kolAddress: "0x99...EE12",
    kolAvatar: "🧙‍♂️",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    followers: "$620.0K followers",
    winRate: 85.0,
    wins: 72,
    losses: 13,
    pnl: "+$27.10M",
    ...
    kdaRatio: "5.54",
    totalVolume: "$230.50M",
    bestCall: "$SPX6900 (+$520.0K)",
    topHolding: { name: "GIGAI", ticker: "$GIGAI", avatar: "🗿", kolBag: "$85.0K" },
  },
  {
    id: "hayes",
    rank: 12,
    kolName: "Arthur Hayes",
    kolHandle: "@CryptoHayes",
    kolAddress: "0x55...FA01",
    kolAvatar: "🏎️",
    tierBadge: "Whale KOL",
    tierIcon: "🐋",
    category: "Whale KOLs",
    followers: "$450.0K followers",
    winRate: 79.2,
    wins: 61,
    losses: 16,
    pnl: "+$25.80M",
    ...
    kdaRatio: "3.81",
    totalVolume: "$215.00M",
    bestCall: "$KATE (+$340.0K)",
    topHolding: { name: "KATE", ticker: "$KATE", avatar: "👑", kolBag: "$72.0K" },
  },
  {
    id: "kbm",
    rank: 13,
    kolName: "Keyboard Monkey",
    kolHandle: "@KBM_Alpha",
    kolAddress: "0x33...11A8",
    kolAvatar: "🐵",
    tierBadge: "Early Sniper",
    tierIcon: "🎯",
    category: "Early Snipers",
    followers: "$180.0K followers",
    winRate: 76.4,
    wins: 82,
    losses: 25,
    pnl: "+$24.50M",
    ...
    kdaRatio: "3.28",
    totalVolume: "$198.40M",
    bestCall: "$PEPEBOT (+$290.0K)",
    topHolding: { name: "PEPEBOT", ticker: "$PEPEBOT", avatar: "🤖", kolBag: "$64.0K" },
  },
  {
    id: "hsaka",
    rank: 14,
    kolName: "Hsaka",
    kolHandle: "@HsakaTrades",
    kolAddress: "0x77...22C4",
    kolAvatar: "🐱",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    followers: "$380.0K followers",
    winRate: 78.0,
    wins: 55,
    losses: 15,
    pnl: "+$23.20M",
    ...
    kdaRatio: "3.67",
    totalVolume: "$185.20M",
    bestCall: "$FOUR (+$260.0K)",
    topHolding: { name: "FOUR", ticker: "$FOUR", avatar: "4️⃣", kolBag: "$58.0K" },
  },
  {
    id: "sisyphus",
    rank: 15,
    kolName: "Sisyphus",
    kolHandle: "@0xSisyphus",
    kolAddress: "0x12...99B0",
    kolAvatar: "🪨",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$220.0K followers",
    winRate: 74.5,
    wins: 44,
    losses: 15,
    pnl: "+$22.10M",
    ...
    kdaRatio: "2.93",
    totalVolume: "$172.00M",
    bestCall: "$CZPEPE (+$230.0K)",
    topHolding: { name: "CZPEPE", ticker: "$CZPEPE", avatar: "🐸", kolBag: "$51.0K" },
  },
  {
    id: "kaleo",
    rank: 16,
    kolName: "CryptoKaleo",
    kolHandle: "@CryptoKaleo",
    kolAddress: "0x88...66F3",
    kolAvatar: "🎨",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    followers: "$590.0K followers",
    winRate: 73.0,
    wins: 68,
    losses: 25,
    pnl: "+$21.40M",
    ...
    kdaRatio: "2.72",
    totalVolume: "$165.80M",
    bestCall: "$GCAT (+$210.0K)",
    topHolding: { name: "GCAT", ticker: "$GCAT", avatar: "💎", kolBag: "$47.0K" },
  },
  {
    id: "cl207",
    rank: 17,
    kolName: "CL207",
    kolHandle: "@CL207",
    kolAddress: "0x44...33E9",
    kolAvatar: "🦾",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    followers: "$210.0K followers",
    winRate: 80.5,
    wins: 49,
    losses: 12,
    pnl: "+$20.80M",
    ...
    kdaRatio: "4.08",
    totalVolume: "$158.40M",
    bestCall: "$AURA (+$250.0K)",
    topHolding: { name: "AURA", ticker: "$AURA", avatar: "✨", kolBag: "$43.0K" },
  },
  {
    id: "tetranode",
    rank: 18,
    kolName: "Tetranode",
    kolHandle: "@Tetranode",
    kolAddress: "0xAA...0044",
    kolAvatar: "🏛️",
    tierBadge: "Whale KOL",
    tierIcon: "🐋",
    category: "Whale KOLs",
    followers: "$175.0K followers",
    winRate: 82.0,
    wins: 41,
    losses: 9,
    pnl: "+$19.90M",
    ...
    kdaRatio: "4.56",
    totalVolume: "$149.00M",
    bestCall: "$PCLON (+$280.0K)",
    topHolding: { name: "PEPECLON", ticker: "$PCLON", avatar: "🐸", kolBag: "$39.0K" },
  },
  {
    id: "bluntz",
    rank: 19,
    kolName: "Bluntz",
    kolHandle: "@Bluntz_Capital",
    kolAddress: "0x66...77D2",
    kolAvatar: "🌊",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$260.0K followers",
    winRate: 75.0,
    wins: 51,
    losses: 17,
    pnl: "+$19.10M",
    ...
    kdaRatio: "3.00",
    totalVolume: "$142.50M",
    bestCall: "$MCAT (+$220.0K)",
    topHolding: { name: "MOONCAT", ticker: "$MCAT", avatar: "🐱", kolBag: "$36.0K" },
  },
  {
    id: "spartan2",
    rank: 20,
    kolName: "Spartan Alpha",
    kolHandle: "@SpartanAlpha",
    kolAddress: "0xBB...55C1",
    kolAvatar: "⚔️",
    tierBadge: "Early Sniper",
    tierIcon: "🎯",
    category: "Early Snipers",
    followers: "$145.0K followers",
    winRate: 77.2,
    wins: 64,
    losses: 19,
    pnl: "+$18.50M",
    ...
    kdaRatio: "3.37",
    totalVolume: "$136.20M",
    bestCall: "$KATE (+$200.0K)",
    topHolding: { name: "KATE", ticker: "$KATE", avatar: "👑", kolBag: "$34.0K" },
  },
  {
    id: "unipcs",
    rank: 21,
    kolName: "Unipcs (Bonk Guy)",
    kolHandle: "@theunipcs",
    kolAddress: "0xCC...8899",
    kolAvatar: "🐕",
    tierBadge: "Ecosystem Lead",
    tierIcon: "👑",
    category: "Tier 1 KOLs",
    followers: "$215.0K followers",
    winRate: 76.0,
    wins: 57,
    losses: 18,
    pnl: "+$17.80M",
    ...
    kdaRatio: "3.17",
    totalVolume: "$129.80M",
    bestCall: "$BONK (+$310.0K)",
    topHolding: { name: "BONK2", ticker: "$BONK2", avatar: "🐶", kolBag: "$42.0K" },
  },
  {
    id: "gainzy",
    rank: 22,
    kolName: "Gainzy",
    kolHandle: "@gainzy222",
    kolAddress: "0xDD...1122",
    kolAvatar: "🎰",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$340.0K followers",
    winRate: 71.5,
    wins: 45,
    losses: 18,
    pnl: "+$17.10M",
    ...
    kdaRatio: "2.50",
    totalVolume: "$124.00M",
    bestCall: "$ROLL (+$180.0K)",
    topHolding: { name: "ROLL", ticker: "$ROLL", avatar: "🎲", kolBag: "$30.0K" },
  },
  {
    id: "miles",
    rank: 23,
    kolName: "Miles Deutscher",
    kolHandle: "@milesdeutscher",
    kolAddress: "0xEE...3344",
    kolAvatar: "📊",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    followers: "$510.0K followers",
    winRate: 74.2,
    wins: 62,
    losses: 21,
    pnl: "+$16.40M",
    ...
    kdaRatio: "2.95",
    totalVolume: "$118.50M",
    bestCall: "$DEUT (+$195.0K)",
    topHolding: { name: "DEUT", ticker: "$DEUT", avatar: "📈", kolBag: "$38.0K" },
  },
  {
    id: "rektproof",
    rank: 24,
    kolName: "RektProof",
    kolHandle: "@RektProof",
    kolAddress: "0xFF...5566",
    kolAvatar: "🛡️",
    tierBadge: "Early Sniper",
    tierIcon: "🎯",
    category: "Early Snipers",
    followers: "$190.0K followers",
    winRate: 75.8,
    wins: 50,
    losses: 16,
    pnl: "+$15.80M",
    ...
    kdaRatio: "3.13",
    totalVolume: "$112.40M",
    bestCall: "$PROOF (+$170.0K)",
    topHolding: { name: "PROOF", ticker: "$PROOF", avatar: "🔒", kolBag: "$29.0K" },
  },
  {
    id: "defisaint",
    rank: 25,
    kolName: "DeFi Saint",
    kolHandle: "@defisaint",
    kolAddress: "0x11...7788",
    kolAvatar: "😇",
    tierBadge: "Whale KOL",
    tierIcon: "🐋",
    category: "Whale KOLs",
    followers: "$130.0K followers",
    winRate: 79.0,
    wins: 38,
    losses: 10,
    pnl: "+$15.20M",
    ...
    kdaRatio: "3.80",
    totalVolume: "$106.80M",
    bestCall: "$SAINT (+$220.0K)",
    topHolding: { name: "SAINT", ticker: "$SAINT", avatar: "🕊️", kolBag: "$35.0K" },
  },
  {
    id: "loomdart",
    rank: 26,
    kolName: "Loomdart",
    kolHandle: "@loomdart",
    kolAddress: "0x22...99AA",
    kolAvatar: "🧶",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    followers: "$280.0K followers",
    winRate: 76.5,
    wins: 42,
    losses: 13,
    pnl: "+$14.60M",
    ...
    kdaRatio: "3.23",
    totalVolume: "$101.50M",
    bestCall: "$LOOM (+$190.0K)",
    topHolding: { name: "LOOM", ticker: "$LOOM", avatar: "🧵", kolBag: "$32.0K" },
  },
  {
    id: "runner",
    rank: 27,
    kolName: "RunnerXBT",
    kolHandle: "@RunnerXBT",
    kolAddress: "0x33...BBCC",
    kolAvatar: "🏃",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$165.0K followers",
    winRate: 72.0,
    wins: 46,
    losses: 18,
    pnl: "+$14.10M",
    ...
    totalVolume: "$96.20M",
    bestCall: "$RUN (+$165.0K)",
    topHolding: { name: "RUN", ticker: "$RUN", avatar: "👟", kolBag: "$27.0K" },
  },
  {
    id: "solbigdog",
    rank: 28,
    ...
    kdaRatio: "2.94",
    totalVolume: "$91.80M",
    bestCall: "$DOGSOL (+$185.0K)",
    topHolding: { name: "DOGSOL", ticker: "$DOGSOL", avatar: "🦮", kolBag: "$31.0K" },
  },
  {
    id: "pentoshi",
    rank: 29,
    kolName: "Pentoshi",
    kolHandle: "@Pentosh1",
    kolAddress: "0x55...FF00",
    kolAvatar: "⛩️",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    followers: "$740.0K followers",
    winRate: 77.0,
    wins: 58,
    losses: 17,
    pnl: "+$13.10M",
    ...
    kdaRatio: "3.41",
    totalVolume: "$87.40M",
    bestCall: "$TORI (+$210.0K)",
    topHolding: { name: "TORI", ticker: "$TORI", avatar: "🏮", kolBag: "$36.0K" },
  },
  {
    id: "hornyalpha",
    rank: 30,
    kolName: "Horny Alpha",
    kolHandle: "@HornyAlpha",
    kolAddress: "0x66...1122",
    kolAvatar: "🦄",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    followers: "$110.0K followers",
    winRate: 71.0,
    wins: 40,
    losses: 16,
    pnl: "+$12.60M",
    ...
    kdaRatio: "2.50",
    totalVolume: "$83.00M",
    bestCall: "$HORN (+$150.0K)",
    topHolding: { name: "HORN", ticker: "$HORN", avatar: "🦄", kolBag: "$25.0K" },
  },
  {
    id: "frankdegods",
    rank: 31,
    kolName: "Frank DeGods",
    kolHandle: "@frankdegods",
    kolAddress: "0x77...3344",
    kolAvatar: "🕶️",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    followers: "$430.0K followers",
    winRate: 75.0,
    wins: 48,
    losses: 16,
    pnl: "+$12.10M",
    ...
    kdaRatio: "3.00",
    totalVolume: "$79.20M",
    bestCall: "$DUST (+$240.0K)",
    topHolding: { name: "DUST", ticker: "$DUST", avatar: "🌪️", kolBag: "$33.0K" },
  },
  {
    id: "tradermayne",
    rank: 32,
    kolName: "Trader Mayne",
    kolHandle: "@trader1mayne",
    kolAddress: "0x88...5566",
    kolAvatar: "🎯",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    followers: "$370.0K followers",
    winRate: 73.8,
    wins: 51,
    losses: 18,
    pnl: "+$11.70M",
    ...
    kdaRatio: "2.83",
    totalVolume: "$75.60M",
    bestCall: "$MAYNE (+$175.0K)",
    topHolding: { name: "MAYNE", ticker: "$MAYNE", avatar: "🏹", kolBag: "$28.0K" },
  },
  {
    id: "gordongekko",
    rank: 33,
    kolName: "Gordon Gekko",
    kolHandle: "@GordonGekk0",
    kolAddress: "0x99...7788",
    kolAvatar: "💼",
    tierBadge: "Whale KOL",
    tierIcon: "🐋",
    category: "Whale KOLs",
    followers: "$250.0K followers",
    winRate: 80.0,
    wins: 36,
    losses: 9,
    pnl: "+$11.20M",
    ...
    kdaRatio: "4.00",
    totalVolume: "$72.10M",
    bestCall: "$GREED (+$260.0K)",
    topHolding: { name: "GREED", ticker: "$GREED", avatar: "💰", kolBag: "$37.0K" },
  },
  {
    id: "notsofast",
    rank: 34,
    ...
    kdaRatio: "3.25",
    totalVolume: "$68.90M",
    bestCall: "$SLOW (+$180.0K)",
    topHolding: { name: "SLOW", ticker: "$SLOW", avatar: "🐌", kolBag: "$29.0K" },
  },
  {
    id: "degenape",
    rank: 35,
    kolName: "Degen Ape",
    kolHandle: "@DegenApeAcademy",
    kolAddress: "0xBB...CCDD",
    kolAvatar: "🦧",
    tierBadge: "Early Sniper",
    tierIcon: "🎯",
    category: "Early Snipers",
    ...
    totalVolume: "$65.40M",
    bestCall: "$APE (+$165.0K)",
    topHolding: { name: "APE", ticker: "$APE", avatar: "🍌", kolBag: "$26.0K" },
  },
  {
    id: "ledgerstatus",
    rank: 36,
    kolName: "Ledger Status",
    kolHandle: "@ledgerstatus",
    kolAddress: "0xCC...EEFF",
    kolAvatar: "📒",
    tierBadge: "Tier 1 KOL",
    tierIcon: "🔥",
    category: "Tier 1 KOLs",
    ...
    kdaRatio: "2.69",
    totalVolume: "$62.30M",
    bestCall: "$LEDGER (+$155.0K)",
    topHolding: { name: "LEDGER", ticker: "$LEDGER", avatar: "📘", kolBag: "$24.0K" },
  },
  {
    id: "redphone",
    rank: 37,
    kolName: "Redphone",
    kolHandle: "@redphonecrypto",
    kolAddress: "0xDD...0011",
    kolAvatar: "☎️",
    tierBadge: "Alpha Caller",
    tierIcon: "⚡",
    category: "Alpha Callers",
    ...
    kdaRatio: "2.53",
    totalVolume: "$59.50M",
    bestCall: "$RING (+$145.0K)",
    topHolding: { name: "RING", ticker: "$RING", avatar: "📞", kolBag: "$22.0K" },
  },
  {
    id: "loomdart2",
    rank: 38,
    ...
    kdaRatio: "2.80",
    totalVolume: "$56.80M",
    bestCall: "$BULLSEYE (+$160.0K)",
    topHolding: { name: "BULLSEYE", ticker: "$BULLSEYE", avatar: "🎯", kolBag: "$23.0K" },
  },
  {
    id: "whaledegen",
    rank: 39,
    kolName: "Whale Degen",
    kolHandle: "@WhaleDegen",
    kolAddress: "0xFF...4455",
    kolAvatar: "🐋",
    tierBadge: "Whale KOL",
    tierIcon: "🐋",
    category: "Whale KOLs",
    followers: "$160.0K followers",
    winRate: 78.5,
    wins: 33,
    losses: 9,
    pnl: "+$8.70M",
    ...
    kdaRatio: "3.67",
    totalVolume: "$54.20M",
    bestCall: "$SPLASH (+$210.0K)",
    topHolding: { name: "SPLASH", ticker: "$SPLASH", avatar: "🌊", kolBag: "$28.0K" },
  },
  {
    id: "crypto_bitlord",
    rank: 40,
    kolName: "Crypto Bitlord",
    kolHandle: "@crypto_bitlord7",
    kolAddress: "0x00...6677",
    kolAvatar: "🏴‍☠️",
    tierBadge: "OG Trader",
    tierIcon: "👑",
    category: "OG Traders",
    ...
    kdaRatio: "2.40",
    totalVolume: "$51.60M",
    bestCall: "$PIRATE (+$135.0K)",
    topHolding: { name: "PIRATE", ticker: "$PIRATE", avatar: "⚓", kolBag: "$20.0K" },
  },
];
    ...
    <div className={styles.leaderboardSectionWrapper}>
      ...
      <div className={styles.lbTableContainer}>
        <table className={styles.lbTable}>
          ...
          <tbody>
            {filteredLeaderboardEntries.slice((leaderboardPage - 1) * 10, leaderboardPage * 10).map((kol) => {
              const rankPillClass =
                kol.rank === 1
                  ? styles.rankPillGold
                  : kol.rank === 2
